...
<div class="row">
    <div class="col-md-6">
     <h1>7. How can you make a list that lists the items with bullets?</h1></div>
</div> 
  <div class="radio">
  <label><input type="radio" name="optradio" value="UL">UL</label>
</div>
<div class="radio">
...
<?php
	if(isset($_POST['submit']))
	{
		...
		{
			//echo 'true';
			echo '<a href="que8.php" class="btn">Next>></a>';
		}
		else
		{
