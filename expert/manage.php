...
<body>
	...
	<br>
	<?php
		$query = "SELECT FirstName,MiddleName,LastName,Gender,Email_id,UserName,Password FROM expert_info WHERE UserName='$original_username'";
	...
	if(!empty($_POST['fname'])&&!empty($_POST['lname']))
	{
		if(isset($_POST['btn']))
		{
			...
			$password = $_POST['pass'];
			$query = "UPDATE expert_info SET FirstName='$fname',MiddleName='$mname',LastName='$lname',Gender='$gender',Email_id='$email',UserName='$new_username',Password='$password' WHERE UserName='$original_username'";
			$result = mysqli_query($strconn,$query);
			if($result)
			{
